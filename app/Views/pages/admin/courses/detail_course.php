                    ...
                    <div class="card-body flex-row items-start gap-4">
                        ...
                        <div class="flex-grow">
                            <h2 class="font-medium text-base">
                                <a href="<?= site_url('course-content/' . $course->id . '/' . $content->id) ?>" target="_blank" class="hover:text-blue-600">
                        ...
                        <div class="dropdown dropdown-end ml-auto">
                            ...
                            <ul tabindex="0" class="dropdown-content menu menu-sm bg-base-100 shadow rounded-box w-40">
                                <li>
                                    <a href="<?= site_url('course-content/' . $content->course_id . '/' . $content->id) ?>" target="_blank">Open</a>
                                </li>
                                <li>
                                    <a href="<?= site_url('course-content/edit/' . $content->id) ?>">Edit</a>
                                </li>
                                <li>
                                    <button onclick="document.getElementById('deleteModalContent<?= $content->id ?>').showModal()" class="w-full text-left">
                                        Delete
                                    </button>
                                </li>
                            </ul>
