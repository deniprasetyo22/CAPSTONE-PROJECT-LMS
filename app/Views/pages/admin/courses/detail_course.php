...
<div class="tabs tabs-box">
    ...
    <div class="tab-content bg-base-100 border-base-300 p-6">
        <div class="flex justify-end mb-4">
            <a href="<?= site_url('discussion-form/' . $course->id) ?>" class="btn bg-blue-200 btn-sm">
        ...
        <div class="space-y-4">
            ...
            <div class="card card-sm bg-base-100 border border-gray-300 hover:bg-base-200">
                <div class="card-body flex-row items-start gap-4">
                    ...
                    <div class="flex-grow">
                        <h2 class="font-medium text-base">
                            <a href="<?= site_url('discussion/' . $discussion->id) ?>" target="_blank"
                ...
                <ul>
                    ...
                    <li class="flex items-center gap-4 p-4 border rounded-lg mb-2">
                        ...
                        <button class="ml-auto btn btn-sm btn-ghost text-primary flex items-center gap-1"
                            onclick="document.getElementById('deleteModal<?= $lecturer->id ?>').showModal()">
                        ...
                        <dialog id="deleteModal<?= $lecturer->id ?>" class="modal">
                            <div class="modal-box">
                                ...
                                <div class="modal-action">
                                    ...
                                    <form action="<?= site_url('remove_lecturer_course/' . $lecturer->id) ?>"
                                        method="post">
                                        <?= csrf_field() ?>
                                        <input type="hidden" name="_method" value="DELETE">
                                        <button type="submit" class="btn btn-success text-white">Yes, Delete</button>
