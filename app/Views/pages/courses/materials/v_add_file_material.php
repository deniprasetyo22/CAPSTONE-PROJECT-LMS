...
<?= $this->section('title') ?>Add Course Content File<?= $this->endSection() ?>
...
<div>
    ...
    <div class="bg-gray-200 rounded-md px-4">
        <div class="breadcrumbs mb-6">
            <ul>
                ...
                <li><a href="<?= url_to('show_course', $courseContent->course_id) ?>">Course Details</a></li>
                <li><a href="<?= url_to('show_material', $courseContent->course_id, $courseContent->id) ?>">Material</a>
                </li>
                <li class="font-semibold">Add File Material</li>
            </ul>
        </div>
    </div>
    <div class="card card-lg border border-gray-300 shadow-lg w-full">
        <div class="card-body">
            ...
            <form action="<?= url_to('store_file_material',$courseContent->id, $courseContent->file_url) ?>"
                method="post" id="courseContentFileForm" enctype="multipart/form-data">
                <?php csrf_field() ?>
                <div>
