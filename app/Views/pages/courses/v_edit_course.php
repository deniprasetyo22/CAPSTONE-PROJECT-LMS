...
<div>
    ...
    <div class="card card-lg border border-gray-300 shadow-lg w-full">
        <div class="card-body">
            ...
            <form action="<?= url_to('update_course', $course->id) ?>" method="post" id="courseRegistrationForm">
                <?= csrf_field() ?>
                ...
                <fieldset class="mb-4">
                    ...
                    <input type="text" name="name" data-pristine-required
                        ...
                        placeholder="Course Name" value="<?= old('name') ?? esc($course->name ?? '') ?>">
                </fieldset>
                ...
                <fieldset class="mb-4">
                    ...
                    <input type="text" name="enrollment_code" id="enrollment_code"
                        ...
                        data-pristine-required data-pristine-required-message="Enrollment Code is required"
                        placeholder="CS101" value="<?= old('enrollment_code') ?? esc($course->enrollment_code) ?>">
                </fieldset>
