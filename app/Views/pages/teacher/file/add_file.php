...
<div>
    ...
    <div class="bg-gray-200 rounded-md px-4">
        <div class="breadcrumbs mb-6">
            <ul>
                ...
                <li><a href="<?= url_to('list_courses') ?>">Course Content Files</a></li>
                <li class="font-semibold">Create File</li>
            </ul>
        </div>
    </div>
    <div class="card card-lg border border-gray-300 shadow-lg w-full">
        <div class="card-body">
            ...
            <?= form_open_multipart('file/' . $course_content_id, ['id' => 'courseContentFileForm', 'class' => 'container mt-4']) ?>
            <div>
                ...
                <div class="mt-4">
                    <iframe
                        id="file-preview"
                        class="w-full border rounded-xl shadow-md"
                        height="500"
                        style="display: none;">
                    </iframe>
                </div>
